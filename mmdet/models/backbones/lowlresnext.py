...
from .lowlresnet import Bottleneck as _Bottleneck
...
class LowlResNeXt(LowlResNet):
    """ResNeXt backbone with low level features.
    ...
    def __init__(self, groups=1, base_width=4, **kwargs):
        ...
        super(LowlResNeXt, self).__init__(**kwargs)
